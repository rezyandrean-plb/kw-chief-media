  ...
  const conversations = [
    {
      ...
      unread: true,
      avatar: '/images/vendors/chief-media.webp'
    },
    {
      id: 2,
      vendor: 'LFG Content',
      ...
      timestamp: '1 day ago',
      unread: false,
      avatar: '/images/vendors/lfg-content.webp'
    },
    {
      id: 3,
      vendor: 'Tubear',
      ...
      unread: false,
      avatar: '/images/vendors/tubear.webp'
    }
  ];
                  ...
                  <div className="p-4 border-b border-gray-200">
                    <div className="flex items-center space-x-3">
                      <img
                        ...
                        alt={selectedConversation.vendor}
