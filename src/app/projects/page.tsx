...
export default function RealtorProjects() {
  ...
  const mockProjects = useMemo(() => [
    {
      ...
      services: ['Real Estate Photography', 'Drone Photography']
    },
    {
      id: 2,
      ...
      services: ['3D Virtual Tour', 'Floor Plan Integration']
    },
    {
      id: 3,
      ...
      services: ['Video Walkthrough', 'Drone Footage', 'Video Editing']
    },
    {
      id: 4,
      title: 'East Coast Property Photography',
      vendor: 'Chief Media',
      status: 'active',
      amount: 600,
      dueDate: '2024-01-18',
  ...
  const filteredProjects = projects.filter(project => {
    ...
    if (filter === 'pending_approval') return project.status === 'pending_approval';
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Track and manage all your vendor projects
              </p>
            </div>
            <Link
              href="/vendors"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8">
              {[
                ...
                { key: 'pending_approval', label: 'Pending Approval', count: projects.filter(p => p.status === 'pending_approval').length },
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-2">Vendor: {project.vendor}</p>
                  ...
                  <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                    <div className="flex items-center">
                      ...
                      <p className="text-sm text-yellow-800">
                        This project is ready for your review and approval.
                      </p>
                    </div>
                  </div>
                )}
        ...
        {filteredProjects.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {filter === 'all' 
                ? "You don't have any projects yet. Start by browsing vendors and submitting enquiries."
                : `No ${filter === 'pending_approval' ? 'pending approval' : filter} projects at the moment.`
              }
            </p>
            {filter === 'all' && (
              <div className="mt-6">
